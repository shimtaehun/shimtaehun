...
> ㈜디엠티랩스 인턴 · 1인 개발 · Python · FastAPI · MySQL · 사내 STT/TTS/오픈웨이트 LLM 연동 · React · Jenkins · Kaniko · Helm · Kubernetes · 사내 프로젝트라 코드는 비공개
...
### 🧒 아동 영어학습 튜터 PoC
> ㈜디엠티랩스 인턴 · 1인 개발 · Python · FastAPI · 사내 STT/TTS/LLM 연동 · 문항·채점·난이도 설계 · 사내 프로젝트라 코드는 비공개
