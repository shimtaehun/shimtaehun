...
- 🧑‍💻 AI 스타트업 인턴(2026.07–09) — 독거노인 개인화 음성 말벗 PoC를 **기획 구체화부터 사내 배포까지 1인으로** 개발 (사내 프로젝트라 코드는 비공개)
...
### 🗣️ Senior Companion — 독거노인 개인화 음성 말벗 (AI 스타트업 인턴, 2026.07–09)
...
### 🧒 아동 영어학습 튜터 PoC (AI 스타트업 인턴, 2026.08–09)
